 ...
 */
package com.xwiki.confluenceextra;
...
/**
 * Base class for confluence macro converter tests.
 *
 * @version $Id$
 */
...
public abstract class AbstractIntegrationTests
{
    ...
    private static final WikiReference WIKI_REFERENCE = new WikiReference("com/xwiki");
    ...
    public void initialized(MockitoComponentManager componentManager) throws Exception
    {
        ...
        when(xwikiContext.getWikiReference()).thenReturn(new WikiReference("com/xwiki"));
        XWiki xwiki = mock(XWiki.class);
        when(xwikiContext.getWiki()).thenReturn(xwiki);
        when(xwiki.getDefaultLocale(any())).thenReturn(Locale.ENGLISH);
        DocumentAccessBridge accessBridge = componentManager.registerMockComponent(DocumentAccessBridge.class);
        when(accessBridge.getAttachmentURL(any(), eq(false))).thenReturn("someUrl");

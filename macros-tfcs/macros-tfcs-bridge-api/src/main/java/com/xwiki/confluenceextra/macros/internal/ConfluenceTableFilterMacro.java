...
/**
 * Confluence Macro bridge for table-filter.
 *
 * @version $Id$
 */
@Component
@Singleton
@Named(ConfluenceTableFilterMacro.ID)
public class ConfluenceTableFilterMacro extends AbstractMacro<ConfluenceTableFilterMacroParameters>
{
    static final String ID = "confluence_table-filter";
     ...
     * Constructor.
     */
    public ConfluenceTableFilterMacro()
    {
        super("Confluence Table Filter Macro Bridge", "Bridge macro for Confluence Table Filter.",
            new DefaultContentDescriptor("Content", true, Block.LIST_BLOCK_TYPE),
            ConfluenceTableFilterMacroParameters.class);
    }
    ...
    @Override
    public List<Block> execute(ConfluenceTableFilterMacroParameters parameters, String content,
        MacroTransformationContext context) throws MacroExecutionException
    {
        ...
        if (!parameters.getDatepattern().isBlank()) {
            // datepattern parameter.
            dateFormats.add(parameters.getDatepattern());
        }
